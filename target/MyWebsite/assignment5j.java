...
@WebServlet(name = "Assignment5j", urlPatterns = "/assignment5j")
public class assignment5j extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            {
                request.setAttribute("Email_error", "Your must enter email as format example@example.com");
                kk++;
            }
            else
            {
